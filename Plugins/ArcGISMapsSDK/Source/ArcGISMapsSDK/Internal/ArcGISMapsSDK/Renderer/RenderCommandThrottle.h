...
namespace Renderer
{
class FRenderCommandThrottle final
{
public:
	...
	FRenderCommandThrottle();
	FRenderCommandThrottle(const FRenderCommandThrottle&) = delete;
	FRenderCommandThrottle(FRenderCommandThrottle&&) = delete;
	FRenderCommandThrottle& operator=(const FRenderCommandThrottle&) = delete;
	FRenderCommandThrottle& operator=(FRenderCommandThrottle&&) = delete;
	~FRenderCommandThrottle();

	bool DoThrottle(const GameEngine::RenderCommandQueue::RenderCommand& renderCommand);
