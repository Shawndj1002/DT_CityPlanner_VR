...
{
class FGPUResourceMaterial final
{
public:
	...
	void SetVector(const FString& Name, const FVector4& Value);
	void SetTexture(const FString& Name, const TSharedPtr<const FGPUResourceRenderTarget>& Value);
	void SetTexture(const FString& Name, const TSharedPtr<const FGPUResourceTexture2D>& Value);
