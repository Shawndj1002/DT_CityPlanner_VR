...
namespace Event
{
using ArcGISElevationSourceViewStateChangedEvent =
	std::function<void(Esri::GameEngine::Elevation::Base::ArcGISElevationSource& elevationSource,
					   Esri::GameEngine::View::State::ArcGISElevationSourceViewState& elevationSourceViewState)>;
} // namespace Event
} // namespace View
} // namespace GameEngine
} // namespace Esri
